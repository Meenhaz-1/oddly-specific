...
const PHASES = [
  {
    ...
    lines: [
      ...
      'Following a promising footnote',
      'Looking past the obvious results',
      'Finding the source behind the source',
      'Checking what the archive says',
    ],
  },
  {
    ...
    lines: [
      ...
      'Replacing a source that only repeats the claim',
      'Tracing the number to its first source',
      'Checking whether the quote is real',
      'Cutting a claim that gets shakier on inspection',
    ],
  },
  {
    head: 'Throwing out the boring ones',
    lines: [
      'The strongest two make the cut',
      'This one is too easy',
      'Keeping the one about the bricks',
      'Ordering them so the best lands last',
      'This clue gives away too much',
      'One answer has two valid rivals',
      'Rewriting the clue, not adding another',
      'Keeping the reveal that earns its place',
    ],
  },
];
